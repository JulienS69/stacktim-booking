...
class _$RoleImpl implements _Role {
  const _$RoleImpl(
      ...
      @JsonKey(name: 'name') this.roleName,
  ...
  @override
  String toString() {
    return 'Role(id: $id, roleName: $roleName, guardName: $guardName)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, roleName, guardName);
...
abstract class _Role implements Role {
  const factory _Role(
      ...
      @JsonKey(name: 'name') final String? roleName,
      @JsonKey(name: 'guard_name') final String? guardName}) = _$RoleImpl;
